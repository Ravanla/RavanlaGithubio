...
$.ajax({
  ...
  data: {
    key: 'J6GBZ-HIUYW-AYYRX-RSYQZ-7RYU5-BJBIZ',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function createtime1() {
  var grt = new Date("12/09/2020 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime2() {
  var ascll2 = [`NCC2-036`, `调用前置摄像头拍照成功，识别为「(*^▽^*)」`, `Photo captured: `, ` 🤪 `];
...
function createtime() {
  ...
  // 1977年9月5
  var start = new Date("1977/09/05/ 00:00:00"); // 旅行者1号开始计算的时间
  var dis = Math.trunc(23400000000 + ((now - start) / 1000) * 17); // 距离=秒数*速度 记住转换毫秒
  var unit = (dis / 149600000).toFixed(6);  // 天文单位
  // 网站诞生时间
  var grt = new Date("2021/08/09/ 00:00:00");
...
<a href="javascript:;" rel="noopener external nofollow" class="box" style="background-image: linear-gradient( 135deg, #FFA6B7 10%, #1E2AD2 100%)" onclick="changeBg('linear-gradient( 135deg, #FFA6B7 10%, #1E2AD2 100%)')"></a>
<a href="javascript:;" rel="noopener external nofollow" class="box" style="background-image: linear-gradient( 135deg, #65FDF0 10%, #1D6FA3 100%)" onclick="changeBg('linear-gradient( 135deg, #65FDF0 10%, #1D6FA3 100%)')"></a>
<a href="javascript:;" rel="noopener external nofollow" class="box" style="background-image: linear-gradient( 135deg, #FD6585 10%, #0D25B9 100%)" onclick="changeBg('linear-gradient( 135deg, #FD6585 10%, #0D25B9 100%)')"></a>
<a href="javascript:;" rel="noopener external nofollow" class="box" style="background-image: linear-gradient( 135deg, #C2FFD8 10%, #465EFB 100%)" onclick="changeBg('linear-gradient( 135deg, #C2FFD8 10%, #465EFB 100%)')"></a>
<a href="javascript:;" rel="noopener external nofollow" class="box" style="background-image: linear-gradient( 135deg, #EE9AE5 10%, #5961F9 100%)" onclick="changeBg('linear-gradient( 135deg, #EE9AE5 10%, #5961F9 100%)')"></a>
<a href="javascript:;" rel="noopener external nofollow" class="box" style="background-image: linear-gradient( 135deg, #3B2667 10%, #BC78EC 100%)" onclick="changeBg('linear-gradient( 135deg, #3B2667 10%, #BC78EC 100%)')"></a>
</div>
{% endfolding %}
...
<p><center>
<input type="text" id="pic-link" size="70%" maxlength="1000" placeholder="请输入有效的图片链接，如 https://tuchuang.voooe.cn/images/2023/03/03/mountains-3840x2160-lake-5k-17071.jpg">
</center></p>
<p><center>
